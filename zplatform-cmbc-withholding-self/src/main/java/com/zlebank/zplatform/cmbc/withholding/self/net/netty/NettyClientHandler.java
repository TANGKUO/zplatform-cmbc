	...
	protected synchronized void channelRead0(ChannelHandlerContext ctx, byte[] msg)
		...
		if (dataContainer != null) {
			...
			if ("FAIL".equalsIgnoreCase(respType)) {
				...
				if(Constant.WITHHOLDINGSELF.equals(dataContainer.get("messagecode").toString())){
				...
				}else if(Constant.WITHHOLDINGSELFQUERY.equals(dataContainer.get("messagecode").toString())){
